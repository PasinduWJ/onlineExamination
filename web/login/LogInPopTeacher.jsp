...
<html>
    ...
    <body>
        <div class="bg-modal-tea">
            <div class="modal-content">
                <div class="close-tea">+</div>
                <i class="fas fa-user-circle"></i>
                <form action="login/LogInVal.jsp" class="form-pop" name="teacher" method="post">
                    ...
                    <div class="sub-button">
                        <button class="sub-btn" name="logger" value="teacher" type="submit">LogIn</button>
                    </div>
